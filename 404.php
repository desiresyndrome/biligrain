...
<div class="wrapper">
	...
	<?php include 'head.php';?>
 	...
 	<div class="wraper-404"><div class="block-404">
			<div class="block-404-left"><h2>404</h2></div>
			<div class="block-404-right">
				<h3><?php _e('Сторінку не знайдено ...','ds'); ?></h3>
				<a href="<?php _e('/','ds'); ?>"><?php _e('На головну','ds'); ?></a>
			</div>
		</div></div>
