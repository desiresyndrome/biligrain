...
<div class="wrapper">
	...
	<div class="page-header-wrap my-cover" style="background-image: url(<?php the_field('page-header-bg'); ?>)"><div class="page-header-block">
		...
		<div class="vacansy-info-wrap wraper-100"><div class="vacansy-info-block wraper-940">
			<div class="vacansy-info-flex tabs">
				<div class="vacansy-info-who">
					<ul class="tabs-caption no-user-select">
						<?php if(get_field('vacansy')): ?>
							<?php while(the_repeater_field('vacansy')): ?>
								<li><?php the_sub_field('vacansy-tab-title'); ?></li>
							<?php endwhile; ?>
						<?php endif; ?>
					</ul>
				</div>
				<div class="vacansy-info-text-block">
					<?php if(get_field('vacansy')): ?>
						<?php while(the_repeater_field('vacansy')): ?>
							<div class="tabs-content">
								<h2 class="vacansy-info-text-title"><?php the_sub_field('vacansy-title'); ?></h2>
								<div class="vacansy-info-text">
									<?php the_sub_field('vacansy-text'); ?>
								</div>
							</div>
						<?php endwhile; ?>
					<?php endif; ?>
		...
		<div class="vacansy-form-wrap wraper-100"><div class="vacansy-form-block wraper-1240">
			...
			<div class="contacts-form"><form enctype="multipart/form-data" method="post" id="feedback-form" class="placeholder_gray" autocomplete="off">
				...
				<input name="telFF" class="form-item-tel feedback-form-border" type="tel" placeholder="<?php _e('Телефон','ds'); ?> *" required/>
